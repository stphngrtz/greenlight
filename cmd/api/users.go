...
func (app *application) registerUserHandler(w http.ResponseWriter, r *http.Request) {
	...
	app.logger.Info("token has been generated", "userId", user.Id, "token", token.Plaintext) // this should not be logged...
	...
	err = app.writeJSON(w, http.StatusAccepted, envelope{"user": user}, nil) // accepted, because of async task
	if err != nil {
		app.serverErrorResponse(w, r, err)
	}
}
